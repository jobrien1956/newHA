                ...
                m('.container',
                    m('.row',
                        m('.col-lg-8.col-lg-offset-2.col-md-10.col-md-offset-1',
                            m('.post-heading',
                                m('h2', { style: { color: 'white' } }, dayData.h2),
                                dayData.h3 && m('h3', { style: { color: 'white' } }, dayData.h3),
                                dayData.date && m('p.post-meta', { style: { color: 'white' } }, dayData.date),
                                dayData.stats && m('h3', { style: { color: 'white' } }, dayData.stats)
                            )
                        )
                    )
                )
